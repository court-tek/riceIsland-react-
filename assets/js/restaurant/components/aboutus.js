...
const AboutUs = props => {
  return (<section style={{ paddingTop: "130px" }} id="aboutus">
    <div className="container">
    <div className="owner-image">
      <h2 style={{ fontFamily: "'Open Sans', sans-serif" }}>About Us</h2>
      <img style={{ width: "300px", height: "220px" }} src="https://raw.githubusercontent.com/court-tek/myWebFiles/master/islandOwner.jpg" alt="69" />
    </div>
